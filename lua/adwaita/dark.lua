...
M.set = function()
    ...
    hl('DiagnosticUnderlineError', { fg = colors.red_2, undercurl = true })
    hl('DiagnosticUnderlineWarn', { fg = colors.yellow_6, undercurl = true })
    hl('DiagnosticUnderlineHint', { fg = colors.blue_4, undercurl = true })
    hl('DiagnosticUnderlineInfo', { fg = colors.teal_5, undercurl = true })
