...
M.set = function()
    ...
    hl('TelescopePromptNormal', { bg = colors.dark_2 })
    hl('TelescopePromptBorder', { fg = colors.dark_2, bg = colors.dark_2 })
    hl('TelescopePromptTitle', { fg = colors.dark_2, bg = colors.dark_2 })
