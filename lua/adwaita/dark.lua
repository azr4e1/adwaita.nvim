...
M.set = function()
    ...
    hl('DiagnosticError', { fg = colors.red_2, undercurl = true })
    hl('DiagnosticWarn', { fg = colors.yellow_6, undercurl = true })
    hl('DiagnosticHint', { fg = colors.blue_4, undercurl = true })
    hl('DiagnosticInfo', { fg = colors.teal_5, undercurl = true })
