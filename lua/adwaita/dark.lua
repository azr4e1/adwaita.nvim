...
M.set = function()
    ...
    hl('ErrorMsg', { fg = colors.red_3, bg = colors.libadwaita_dark, undercurl = true })
    ...
    -- Syntax highlight
    hl('Comment', { fg = colors.dark_2, italic = true })
    ...
    hl('Error', { fg = colors.red_3, undercurl = true })
    hl('SpellBad', { fg = colors.red_3, undercurl = true, sp = colors.red_3 })
    hl('SpellCap', { fg = colors.red_3, undercurl = true, sp = colors.red_3 })
    ...
    hl('TelescopePromptNormal', { bg = colors.libadwaita_dark_alt })
    hl('TelescopePromptBorder', { fg = colors.libadwaita_dark_alt, bg = colors.libadwaita_dark_alt })
    hl('TelescopePromptTitle', { fg = colors.libadwaita_dark_alt, bg = colors.libadwaita_dark_alt })
    hl('TelescopePromptCounter', { fg = colors.light_7, bg = colors.libadwaita_dark_alt })
    hl('TelescopePreviewTitle', { fg = colors.libadwaita_popup, bg = colors.libadwaita_popup })
    hl('TelescopeResultsTitle', { fg = colors.libadwaita_popup, bg = colors.libadwaita_popup })
    ...
    hl('DiagnosticUnderlineError', { sp = colors.red_2, undercurl = true })
    hl('DiagnosticUnderlineWarn', { sp = colors.yellow_6, undercurl = true })
    hl('DiagnosticUnderlineHint', { sp = colors.blue_4, undercurl = true })
    hl('DiagnosticUnderlineInfo', { sp = colors.teal_5, undercurl = true })
